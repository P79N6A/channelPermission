...
import com.haier.svc.job.buildin.DubboJob;
import com.haier.svc.job.buildin.SqlJob;
import com.haier.svc.job.buildin.UrlJob;
 ...
 * <p>
 * Job共分以下几种类型：<br />
 * 1. {@link SysJob#TYPE_DUBBO}: 调用Dubbo服务方法的Job，参考{@link DubboJob}；<br />
 * 2. {@link SysJob#TYPE_SQL}: 执行SQL语句的Job，参考{@link SqlJob}；<br />
 * 3. {@link SysJob#TYPE_URL}: 调用Url的Job，参考{@link UrlJob}；<br />
 * 4. {@link SysJob#TYPE_CUSTOM}: 自定义的Job，参考{@link CustomJobLoader}。<br />
 *    
 * @version 1.0
