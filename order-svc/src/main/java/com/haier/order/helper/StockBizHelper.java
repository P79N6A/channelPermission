...
public class StockBizHelper {
        ...
        for (InvStock invStock : invStockList) {
            ...
            if (useGd || useHiPeng || useNewChannel) {
                ...
                if (!stockQtyMap.containsKey(pKey)
                    && ((notSearchAllflag && invStock.getStockQty() > 0) || !notSearchAllflag)) {
    ...
    public static Map<String, String> getAllProductssCodes(OrderCenterItemServiceImpl orderThirdCenterItemService) {
        ServiceResult<List<ProductBase>> productsService = orderThirdCenterItemService.getAllProductsBysCode(null);
     ...
     */
    public static void linkageUpdateStockForSales(OrderCenterItemServiceImpl orderThirdCenterItemService,
        ...
        updateStockForSale(orderThirdCenterItemService, stockInvSectionService, invStockService, stock.getSku(),
            stock.getSecCode(), stock.getStockQty());
    }

    public static void updateStockForSale(OrderCenterItemServiceImpl orderThirdCenterItemService, StockInvSectionService stockInvSectionService,
        ...
        if (stock == null) {
            ...
            StockBizHelper.assignmentValue2InvStock(orderThirdCenterItemService, stockInvSectionService, stock);
     ...
     * @return
     */
    public static ItemBase getItemBaseBySku(OrderCenterItemServiceImpl orderThirdCenterItemService, String sku) {
     ...
     * @return
     */
    public static ItemAttribute getItemAttributeByValueSetIdAndValue(OrderCenterItemServiceImpl orderThirdCenterItemService,
                                                                     String valueSetId,
                                                                     String value) {
     ...
     * @param baseStock
     */
    public static void assignmentValue2InvBaseStock(OrderCenterItemServiceImpl orderThirdCenterItemService,
                                                    StockInvSectionService stockInvSectionService,
                                                    InvBaseStock baseStock) {
        ItemBase itemBase = getItemBaseBySku(orderThirdCenterItemService, baseStock.getSku());
        if (itemBase != null) {
            String productName = itemBase.getMaterialDescription();//产品型号
            baseStock.setProductName(productName);
            ItemAttribute itemAttribute = getItemAttributeByValueSetIdAndValue(orderThirdCenterItemService,
     ...
     * @param stock
     */
    public static void assignmentValue2InvStock(OrderCenterItemServiceImpl orderThirdCenterItemService,
                                                StockInvSectionService stockInvSectionService, InvStock stock) {
        ItemBase itemBase = getItemBaseBySku(orderThirdCenterItemService, stock.getSku());
        if (itemBase != null) {
            String productName = itemBase.getMaterialDescription();//产品型号
     ...
     * @param baseStockLog
     */
    public static void assignmentValue2InvBaseStockLog(OrderCenterItemServiceImpl orderThirdCenterItemService,
                                                       StockInvSectionService stockInvSectionService,
                                                       InvBaseStockLog baseStockLog) {
        ItemBase itemBase = getItemBaseBySku(orderThirdCenterItemService, baseStockLog.getSku());
        if (itemBase != null) {
            String productName = itemBase.getMaterialDescription();//产品型号
