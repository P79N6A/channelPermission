...
import com.haier.order.canceltidan.JdeAndLesLoseValidityResponse;
import com.haier.order.canceltidan.JdeAndLesLoseValidity_Type;
...
@Service
public class OrderCenterInvoiceToTaxServiceImpl {
    private Logger logger = LoggerFactory
            .getLogger(OrderCenterInvoiceToTaxServiceImpl.class);
...
//                        invoiceOutType.setMsg(outputs.getMSG());
    ...
    private InvoiceEntity convertQueryOutType(JdeAndLesLoseValidityResponse.Out out) {
...
//        inType.setZfrq(isOutDateNull(out.getZFRQ()));
    ...
    private JdeAndLesLoseValidity_Type.In convertQueryInputType(QueryInvoiceInputType inputType) {
        JdeAndLesLoseValidity_Type.In in = new JdeAndLesLoseValidity_Type.In();
