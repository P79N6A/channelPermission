...
import com.haier.order.model.PurchaseGdQueueModel;
...
@Service
public class OrderCenterPurchaseGdServiceImpl {
    private static Logger logger = LogManager.getLogger(OrderCenterPurchaseGdServiceImpl.class);
    @Autowired
