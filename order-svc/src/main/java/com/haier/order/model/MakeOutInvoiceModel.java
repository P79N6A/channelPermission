package com.haier.order.model;//package com.haier.orderthird.model;
//
//import com.haier.common.BusinessException;
//import com.haier.common.ServiceResult;
//import com.haier.common.util.JsonUtil;
//import com.haier.common.util.StringUtil;
//import com.haier.orderthird.dateSource.ReadWriteRoutingDataSourceHolder;
//import com.haier.orderthird.multithread.IExcute;
//import com.haier.orderthird.multithread.MultiThreadTool;
//import com.haier.orderthird.multithread.ThreadHelper;
//import com.haier.order.services.OrderThirdCenterEInvoiceServiceImpl;
//import com.haier.order.services.OrderThirdCenterInvoiceToTaxServiceImpl;
//import com.haier.order.services.OrderThirdCenterOrderBizHelper;
//import com.haier.orderthird.util.DateFormatUtil;
...
//    @Autowired
//    private OrderThirdCenterEInvoiceServiceImpl eInvoiceServiceImpl;
////    private InvoiceToSAPService    invoiceToSAPService;
//    @Autowired
//    private ThreadHelper           threadHelper;
//    @Autowired
//    private OrderThirdCenterInvoiceToTaxServiceImpl invoiceToTaxService;
...
////                OrderProductsNew orderProduct = orderProductsDao.get(edit.getOrderProductId());
...
////                Order2ths order2ths = order2thsDao.get(edit.getDiffId());
////                orderId = order2ths.getId();
////                netPointId = 0;
////                opStatus = -1;
////                paymentStatus = -1;
////            } else { //专项开票
////                Order4Invoices order4Invoices = order4InvoicesDao.get(edit.getDiffId());
...
////            orderOperateLogsDao.insert(operateLogs);
...
////        Invoices innerInvoice = invoicesDao.get(edit.getId());
////        if (innerInvoice == null) {
////            innerInvoice = invoicesDao.getByCorderSn(edit.getCOrderSn());
////        }
////        if (innerInvoice == null) {
////            throw new BusinessException("没有找到可更新的发票");
////        }
...
////            }
////
////            Integer pushType = OrderThirdCenterOrderBizHelper.getInvoiceSAPLogsOfPushType(edit, orderProductsDao);
////            boolean sendSap = OrderThirdCenterOrderBizHelper.handelInvoiceSAPLogs(edit, pushType, orderProductsDao,
////                invoiceSAPLogsDao, this.getPathByName("/upfiles/sapblacklist.txt"));
////
////            //            InvoiceSAPLogs invoiceSAPLogs = OrderThirdCenterOrderBizHelper.sapGenerate(invoiceSAPLogsDao,
...
////        Invoices invoices = this.invoicesDao.get(queryInvoice.getId());
////        if (invoices == null) {
...
////            entity.setState((int) resultInvoice.getFpzt().byteValue());
...
////            entity.setBillingTime((long) Integer.parseInt(Ustring.getString(resultInvoice.getKprq() == null ? null : resultInvoice.getKprq().getTime() / 1000)));
////            entity.setEaiWriteTime((long) Integer.parseInt(Ustring.getString(resultInvoice.getSkrq() == null ? null : resultInvoice.getSkrq().getTime() / 1000)));
////            entity.setInvalidTime((long) Integer.parseInt(Ustring.getString(
////                resultInvoice.getZfrq() == null ? null : resultInvoice.getZfrq().getTime() / 1000)));
////            entity.setSuccess((int) InvoiceConst.SUCCESS.byteValue());
////        }
...
//        MemberInvoices memberInvoice = memberInvoicesDao.get(memberInvoiceId);
...
//        memberInvoicesDao.updateForsynInvoices(tempMemberInvoice);
//
//    }
//
//    private void orderProduct(Invoices invoice, Integer makeReceipt,
//                              String remark) throws BusinessException {
//        if (Invoices.CORDERTYPE_COMMON_CORDER_TYPE != invoice.getCOrderType().byteValue()) {
//            return;
//        }
...
//            orderProductsDao.updateForsyncInvoice(tempOrderProduct);
//
//            OrderOperateLogs operateLogs = new OrderOperateLogs();
//            operateLogs.setSiteId(1);
...
//
//            //修改退货申请的发票信息
//            List<OrderRepairsNew> orderRepairsList = orderRepairsDao
...
//                orderRepairsDao.updateForStatus(orderRepairs);
...
//                orderRepairLogsDao.insert(orderRepairsLog);
//            }
//
//        }
//    }
...
//        Order2ths order2ths = order2thsDao.get(diffId);
...
//            order2thsDao.updateForsynInvoices(order2Ths);
//        }
//
//    }
//
...
//        }
//        Integer diffId = invoice.getDiffId();
//        Order4Invoices order4invoices = order4InvoicesDao.get(diffId);
...
//            Integer effect = order4InvoicesDao.updateForsynInvoices(order4Invoices);
//            if (effect < 0) {
...
//        //1、获取开票信息待传HP队列
//        List<InvoiceElectric2Out> list = invoiceElectric2OutDao.getSendToHpList(1000);
...
//        //1、获取开票信息待传HP队列
//        List<InvoiceElectric2Out> list = invoiceElectric2OutDao.getSendToSapList(1000);
//        if (list == null || list.size() == 0) {
...
//        Invoices invoice = invoicesDao.get(invoiceId);
//        if (invoice == null) {
//            invoiceElectric2Out.setLastMessage("发票不存在");
//            invoiceElectric2Out.setCount(invoiceElectric2Out.getCount() + 1);
//            invoiceElectric2Out.setProcessTime(new Date());
//            invoiceElectric2OutDao.updateAfterSync(invoiceElectric2Out);
...
//
//            MemberInvoices memberInvoices = memberInvoicesDao.get(order2ths.getMemberInvoiceId());
//            String invoiceTitle = "";
