...
import com.haier.order.helper.Handler;
import com.haier.order.helper.StockBizHelper;
import com.haier.order.helper.TransHandler;
import com.haier.order.services.OrderCenterEStoreInfoServiceImpl;
...
public class EStoreSyncModel {
    ...
    @Autowired
    private OrderCenterEStoreInfoServiceImpl eStoreInfoServiceImpl;
//    @Autowired
