...
@Repository
public interface OdsTMFXShopSummaryDao {
   ...
   * DATE: 2017-11-07 16:49
   */
  int insertSelective(OdsTMFXShopSummary record);
  /* {
   ...
   * DATE: 2017-11-07 16:49
   */
  OdsTMFXShopSummary selectByPrimaryKey(String id);
  /*{
   ...
   * DATE: 2017-11-07 16:49
   */
  int updateByPrimaryKeySelective(OdsTMFXShopSummary record);
  /*{
   ...
   * 分页查询
   */
  List<OdsTMFXShopSummary> queryShopSummaryList(OdsTMFXShopSummary paging);
   ...
   * @return
   */
  int queryShopSummaryCount(OdsTMFXShopSummary paging);
  /*{
