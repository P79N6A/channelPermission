 ...
 */
@Service
public class BatchUpdateEInvoiceServiceImpl implements BatchUpdateEInvoiceService {

    private static Logger logger = LogManager.getLogger(BatchUpdateEInvoiceServiceImpl.class);
    ...
    @Override
    public HttpJsonResult<Map<String, Object>> doBatchUpdateEInvoiceInfo(String cOrderSns, Map<String, Object> modelMap) {
        ...
        try {
            ...
            for (String cOrderSn : cOrderSnsArray) {
                ...
                try {
                    ServiceResult<Integer> rtn = syncElecInvoiceModel.syncInvoiceInfoFromEInvoiceSystem(invoicesList);
                    if (rtn.getResult() == 0) {
                        errorCount += 1;
