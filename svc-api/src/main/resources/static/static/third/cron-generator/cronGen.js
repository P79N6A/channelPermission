    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $b.popover({
                ...
                template: '<div class="popover" style="max-width:500px !important; width:425px;left:-341.656px;z-index:9999;position:fixed;"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>',
    ...
    $.fn.cronGen.tools = {
      ...
      cronResult: function() {
        ...
        if (result[currentIndex] == "*") {
          for (var i = currentIndex + 1; i < result.length; i++) {
            if (i == 5) {
              result[i] = "?";
            } else {
              result[i] = "*";
