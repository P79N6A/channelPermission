...
var datagridOptions_itemAttribute = {
    ...
    columns: [[
        ...
        {title: '一次质检结果', field: 'rejectOneResult', sortable: false},
        {title: '入库时间', field: 'storageDate', sortable: false,
        	formatter : function(value) {
            	if(value){
        ...
        {title: '二次质检时间', field: 'secondPushTime', sortable: false},
        {title: '二次质检结果', field: 'twoInspectorResult', sortable: false},
    ]],
