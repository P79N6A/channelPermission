var datagridOptions_orderForecastGoal = {
    ...
    columns: [[
        ...
        {title: '退换货HP质检及时率', field: 'field1', sortable: true,colspan:5,align: 'center'},
...
var datagridOptions_orderForecastGoal_1 = {
    ...
    columns: [[
        {title: 'HP质检超期 ', field: 'field0', sortable: true,rowspan:2},
        {title: '合计 ', field: 'field1', sortable: true,rowspan:2},
        {title: '派单', field: 'field2', sortable: true,colspan:4,align: 'center'},


    ],[
        {title: '商城审核', field: 'field3', sortable: true},
        {title: '确认', field: 'field4', sortable: true},
        {title: '派工', field: 'field5', sortable: true},
        {title: '质检', field: 'field6', sortable: true},
    ]],
    striped: true,
    autoRowHeight: true,
    nowrap: true,
