var datagridOptions_orderForecastGoal = {
    ...
    columns: [[
        ...
        {title: '退换货LES入库及时率', field: 'field1', sortable: true,colspan:5,align: 'center'},
...
var datagridOptions_orderForecastGoal_1 = {
    ...
    columns: [[
        {title: '入库超期 ', field: 'field0', sortable: true,rowspan:2},
        {title: '合计 ', field: 'field1', sortable: true,rowspan:2},
        {title: '按单取货入库', field: 'field2', sortable: true,colspan:4,align: 'center'},


    ],[
        {title: '质检', field: 'field3', sortable: true},
        {title: '确认配车取货', field: 'field4', sortable: true},
        {title: '拉回', field: 'field5', sortable: true},
        {title: '入库', field: 'field6', sortable: true},
    ]],
    striped: true,
    autoRowHeight: true,
    nowrap: true,
