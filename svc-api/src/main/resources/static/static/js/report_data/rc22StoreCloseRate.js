var datagridOptions_orderForecastGoal = {
    ...
    columns: [[
        ...
        {title: '退换货22转库及时率', field: 'field1', sortable: true,colspan:5,align: 'center'},
...
var datagridOptions_orderForecastGoal_1 = {
    ...
    columns: [[
        {title: '22转库超期 ', field: 'field0', sortable: true,rowspan:2},
        {title: '合计 ', field: 'field1', sortable: true,rowspan:2},
        {title: '22转库', field: 'field2', sortable: true,colspan:4,align: 'center'},
