var datagridOptions_orderForecastGoal = {
    ...
    columns: [[
        ...
        {title: '退换货审核及时率', field: 'field1', sortable: true,colspan:6,align: 'center'},
        ...
        {title: '平均效率', field: 'field7', sortable: true},
...
var datagridOptions_orderForecastGoal_1 = {
    ...
    columns: [[
        {title: '审核超期 ', field: 'field0', sortable: true,rowspan:2},
        {title: '合计 ', field: 'field1', sortable: true,rowspan:2},
        {title: '审核', field: 'field2', sortable: true,colspan:4,align: 'center'},


    ],[
        {title: '待申请', field: 'field3', sortable: true},
        {title: '用户申请', field: 'field4', sortable: true},
        {title: '人工导入', field: 'field5', sortable: true},
        {title: '审核确认', field: 'field6', sortable: true},
    ]],
    striped: true,
    autoRowHeight: true,
    nowrap: true,
