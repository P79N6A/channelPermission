var datagridOptions_orderForecastGoal = {
    ...
    columns: [[
        ...
        {title: '退换货二次质检及时率', field: 'field1', sortable: true,colspan:5,align: 'center'},
...
var datagridOptions_orderForecastGoal_1 = {
    ...
    columns: [[
        {title: '二次质检超期 ', field: 'field0', sortable: true,rowspan:2},
        {title: '合计 ', field: 'field1', sortable: true,rowspan:2},
        {title: '二次质检', field: 'field2', sortable: true,colspan:4,align: 'center'},


    ],[
        {title: '22转库', field: 'field3', sortable: true},
        {title: '二次质检', field: 'field4', sortable: true},
        {title: '转箱', field: 'field5', sortable: true},
        {title: '转库', field: 'field6', sortable: true},
    ]],
    striped: true,
    autoRowHeight: true,
    nowrap: true,
