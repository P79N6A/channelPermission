    ...
    $("#addDlgSaveBtn").on('click', function () {
      ...
      //  var data = $("#fm").serializeArray();
       ...
       // return;
        ...
        if(data[9].name!="id"){
        	if(data[25].value==null||data[25].value==""){
    	    	data[25].value=0;
    	    }
        }
        
        var url = "/SNpointMaintain/insertOrUpdate";
        $.ajax({
            url: url,
            data: data,
            dataType: 'json',
...
function exp() {
    ...
    window.location.href = "/SNpointMaintain/export?" +param;
...
$("#upload").click(function() {
    ...
    return $.ajaxFileUpload({
        url: '/SNpointMaintain/importTMFXPointMaintainExcel',
        secureuri: false,
        fileElementId: 'file',
        dataType: 'json',
...
$(function () {
  var url = "/SNpointMaintain/getLogInfo";
  $.ajax({
    url: url,
    data: {},
    type: "post",
