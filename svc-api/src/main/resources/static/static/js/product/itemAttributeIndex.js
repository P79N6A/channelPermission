    ...
    'data': {
        'records': [
            ...
            },
            {
                'valueSetId': 'QmControlCode', sortable: true,
                'description': 'QM控制码', sortable: true,
                'value': '0004', sortable: true,
                'valueMeaning': '供应商下达，技术交货条款，QA协议', sortable: true,
            },
            {
                'valueSetId': 'QmControlCode', sortable: true,
                'description': 'QM控制码', sortable: true,
                'value': '0005', sortable: true,
                'valueMeaning': '交货下达，证书', sortable: true,
            },
            {
                'valueSetId': 'QmControlCode', sortable: true,
                'description': 'QM控制码', sortable: true,
                'value': '0006', sortable: true,
                'valueMeaning': '交货下达，技术交货条款，QA协议，证书', sortable: true,
            },
            {
                'valueSetId': 'QmControlCode', sortable: true,
                'description': 'QM控制码', sortable: true,
                'value': '0007', sortable: true,
                'valueMeaning': '交货下达，发票冻结', sortable: true,
            },
            {
                'valueSetId': 'QmControlCode', sortable: true,
                'description': 'QM控制码', sortable: true,
                'value': '8888', sortable: true,
                'valueMeaning': '交货冻结未激活', sortable: true,
            },
        ], 'totalCount': 10
    }
};
