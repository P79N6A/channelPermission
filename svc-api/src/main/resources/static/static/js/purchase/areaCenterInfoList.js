        ...
        if ($(this).linkbutton('options').disabled == false) {
            if (updateFlag) {
                ...
                $.messager.confirm('确认','确定要修改吗？', function(r){
                    if (r){
                        jQuery.ajax({
                            url: "/areacenterinfo/updateAreaCenterInfo",
                            type: "POST",
...
//启用
    $("#openStatus").click(function(){
        ...
        $.messager.confirm('确认','确定要启用吗？', function(r){
            if(r){
                jQuery.ajax({
                    url: "/areacenterinfo/openStatusAreaCenterInfo",
                    type: "POST",
    ...
    $("#closeStatus").click(function(){
        ...
        $.messager.confirm('确认','确定要禁用吗？', function(r){
            if(r){
                jQuery.ajax({
                    url: "/areacenterinfo/closeStatusAreaCenterInfo",
                    type: "POST",
        ...
        if ($(this).linkbutton('options').disabled == false) {
            if(createFlag){
                ...
                $.messager.confirm('确认','确定要创建吗？', function(r){
                    if (r){
                        jQuery.ajax({
                            url: "/areacenterinfo/createAreaCenterInfo",
                            type: "POST",
    ...
    $('#export').click(function(){
        ...
        $.messager.confirm('确认', '确定要导出吗？', function(r){
            if (r){
                $('#areaCenterInfo').attr("action", '/areacenterinfo/AreaCenterInfoExport');
    ...
    $('#exportall').click(function(){
        ...
        $.messager.confirm('确认','确定要全部导出吗？', function(r){
            if (r){
                $('#areaCenterInfo').attr("action", '/areacenterinfo/AreaCenterInfoAllExport');
                $('#areaCenterInfo').submit();
            }
        });
    });
...
$('#search').click(function () {
    ...
    //生成grid
    datagrid = $('#datagrid').datagrid({
        url : "/areacenterinfo/searchAreaCenterInfo",
        fit:true,
        pagination: true,
        pageSize:100,
        pageList:[100,200,300],
