    ...
    $('#gridView').datagrid('getPager').pagination({ 
        ...
        onSelectPage: function (pageNo, pageSize) {
            ...
            $.ajax({
                type: 'POST',
                async: true,
                url: '/pop/commission_target/commission_product_invoice',
                data: {
...
$("#importBtn_orderList").click(function () {
    ...
    $("#exportForm").attr("action","/pop/commission_target/exportCommission_invoice");
    $("#exportForm").submit();
    ...
    function SearchUnit1() {
        ...
        $.ajax({
            ...
            success: function (data, textStatus) {
                ...
                data1 = Sum2(data, data1, "col07", "col10", "col11", "col14", "col15", "col18", "col19", "col22", "col23", "col26");
                ajaxLoadEnd();
