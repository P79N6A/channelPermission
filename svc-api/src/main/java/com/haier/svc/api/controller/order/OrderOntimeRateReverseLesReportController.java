...
@Controller
@RequestMapping(value = "orderles")
public class OrderOntimeRateReverseLesReportController {
    private static org.apache.log4j.Logger logger    = org.apache.log4j.LogManager
            .getLogger(OrderOntimeRateReverseLesReportController.class);
    ...
    @GetMapping("orderOntimeRateReverseLesReport")
    public String mytest(){

        return "order/orderOntimeRateReverseLesReport";
    }
    ...
    @RequestMapping(value = { "/getOrderOntimeRateReverseLesReportList" }, method = { RequestMethod.GET })
...
//                        continue;
    ...
    @RequestMapping(value = { "/getOrderOntimeRateReverseLesReportDetailList" }, method = { RequestMethod.POST })
    String getOrderOntimeRateReverseReportDetailList(HttpServletRequest request,
        ...
        try {
            ...
            modelMap.put("nodeType",nodeType);
        } catch (Exception e) {
            logger.error("[order][orderworkflow]获取及时率网单明细列表时发生未知错误", e);
        }
        return "order/orderOntimeRateReverseLesReportDetailList";
    }
        ...
        for (Map<String, Object> map : list) {
            if (nodeType != null) {
                ...
                if ("audit".equals(nodeType)) {//退换货审核
                    ...
                    if (Arrays.toString(sources).contains(source)) {//判断是否天猫渠道
...
//            List<OrderWorkflowRegion> tempRegionList = null;
    ...
    public List<Map<String, Object>> getOntimeRateReverseDetailList(String repairId,
                                                                    String cOrderSn,
                                                                    String nodeType, PagerInfo pager) {
        List<Map<String, String>> storageList = new ArrayList<Map<String, String>>();
