...
public class CrmExportData {
	...
	public static final String WA_NUM="入WA库数量";
	public static final String SAP_STATUS="推送sap状态";
	public static final String SAP_MESSAGE="推送sap信息";
	public static final String SAP_PROCESSTIME="推送sap时间";
	...
	*/
	public static String[] poListQuery ={ORDER_ID,PO_ID,BILL_ORDER_ID,BILL_TIME_DISPLAY,SO_ID,DN_ID,ED_CHANNEL_NAME,
		...
		STORAGE_ID,STORAGE_NAME,FLOW_FLAG_NAME,RRS_OUT_TIME_DISPLAY,WA_IN_TIME_DISPLAY,WA_NUM,SAP_STATUS,SAP_MESSAGE,SAP_PROCESSTIME
	};
	public static String[] poListExportQuery ={ORDER_ID,PO_ID,BILL_ORDER_ID,BILL_TIME_DISPLAY,SO_ID,DN_ID,ED_CHANNEL_NAME,
			CATEGORY_ID,PRODUCT_GROUP_NAME,MATERIALS_ID,MATERIALS_DESC,QTY,PRICE,T2_AMOUNT,AMOUNT,TOTAL,
			STORAGE_ID,STORAGE_NAME,FLOW_FLAG_NAME,RRS_OUT_TIME_DISPLAY,WA_IN_TIME_DISPLAY,WA_NUM
	};
