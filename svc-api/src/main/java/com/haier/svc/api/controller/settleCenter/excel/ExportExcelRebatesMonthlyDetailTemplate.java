...
@Component
public class ExportExcelRebatesMonthlyDetailTemplate extends AbstractExcelExportTemplateStandard<OdsTMFXRebatesMonthlyDetail> implements ApplicationContextAware{

	@Autowired
	OdsTMFXRebatesMonthlyDetailService odsTMFXRebatesMonthlyDetailService;
...
/*		return new String[][]{{"生态店","年度","期间起","期间止","产业","SKU","型号描述","品牌",
	...
	protected void buildBody(int sheetIndex) {
		...
		odsTMFXRebatesMonthlyDetailService = context.getBean(OdsTMFXRebatesMonthlyDetailService.class);

		Map<String, Object> map=odsTMFXRebatesMonthlyDetailService.export(parameters);
