...
@Component
public class ExportExcelPointSNMaintainTemplate extends AbstractExcelExportTemplateStandard<SNOdsTMFXPointMaintain> implements ApplicationContextAware{

	@Autowired
	SNOdsTMFXPointMaintainService sNOdsTMFXPointMaintainService;
...
/*		return new String[][]{{"生态店","年度","期间起","期间止","产业","SKU","型号描述","品牌",
	...
	protected void buildBody(int sheetIndex) {
		...
		sNOdsTMFXPointMaintainService = context.getBean(SNOdsTMFXPointMaintainService.class);

		Map<String, Object> map=sNOdsTMFXPointMaintainService.export(parameters);
