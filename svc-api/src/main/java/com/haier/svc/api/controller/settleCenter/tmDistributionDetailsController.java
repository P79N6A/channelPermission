...
@Controller
@RequestMapping(value = "/tmDistributionDetails")
public class tmDistributionDetailsController {
    private static Logger     log = LogManager.getLogger(tmDistributionDetailsController.class);
    ...
    @GetMapping("page")
    public String query(){
        return "settleCenter/tmDistributionDetails";
    }
