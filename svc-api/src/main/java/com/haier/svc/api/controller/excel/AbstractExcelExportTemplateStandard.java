 ...
 *
 */
public abstract class AbstractExcelExportTemplateStandard<T> implements ExcelExportTemplateStandard<T> {
	/**
	 * 默认表格宽度
	 */
	 ...
	 */
	@Override
	public void doExport(HttpServletResponse response,String fileName,T parameters) throws IOException {
