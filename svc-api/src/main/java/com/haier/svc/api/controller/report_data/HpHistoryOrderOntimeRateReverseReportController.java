...
@Controller
@RequestMapping(value = "hphistory")
public class HpHistoryOrderOntimeRateReverseReportController {
    ...
    private static org.apache.log4j.Logger log    = org.apache.log4j.LogManager
            .getLogger(HpHistoryOrderOntimeRateReverseReportController.class);

    @RequestMapping(value = { "/getHpKpiOrderOntimeRateReverseReportList.html" }, method = { RequestMethod.GET })
    String getOrderOntimeRateReverseList(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (null != countMap && !countMap.isEmpty()) {
                for (Entry<String, CountEntity> entry : countMap.entrySet()) {
        ...
        return "/report_data/HPOrderOntimeRateReverseReportList";
    }

    @RequestMapping(value = { "/exportHpKpiOrderOntimeRateReverseReport.html" }, method = { RequestMethod.GET })
    ...
    @RequestMapping(value = { "/getHpKpiOrderOntimeRateReverseReportDetailList.html" }, method = { RequestMethod.POST })
    String getOrderOntimeRateReverseReportDetailList(HttpServletRequest request,
        ...
        try {
            ...
            log.error("[histery][orderworkflow]获取及时率网单明细列表时发生未知错误", e);
        }
        return "report_data/HpOrderOntimeRateReverseReportDetailList";
    }
