...
@Controller
@RequestMapping(value = "blporder")
public class BlpOrderOntimeRateReverseReportController {
    ...
    @GetMapping("blporderOntimeRateReverseReport")
    public String mytest(HttpServletRequest request, HttpServletResponse response,
        ...
        return "report_data/blpOrderOntimeRateReverseReport";
    }


    @RequestMapping(value = { "/getOrderOntimeRateReverseReportList.html" }, method = { RequestMethod.GET })
    String getOrderOntimeRateReverseList(HttpServletRequest request, HttpServletResponse response,
        ...
        return "report_data/blpOrderOntimeRateReverseReportList";
    }
    ...
    String getOrderOntimeRateReverseReportDetailList(HttpServletRequest request,
        ...
        return "report_data/blpOrderOntimeRateReverseReportDetailList";
    }
