...
public final class ExportVehicle {
	...
	public static final String LBX_ERR_MSG="LBX错误信息";
	...
	public static final String ACTUAL_COUNT = "LBX入库数量";
	...
	/**	 * 整车直发列表导出的表头	 */
	public static String[] orderListTitle = {ED_CHANNEL_NAME,CATEGORY_ID,PRODUCT_GROUP_NAME,PRICE,VBELNDN1,VBELNDN5,VBELNSPARE,MATERIALS_ID,STORAGE_ID,ACTUAL_COUNT,LBX_STATUS,LBX_ERR_MSG,SAP_STATUS,AMOUNT_ZK,AMOUNT_ZQ,T2_DELIVERY_PREDICTION_ZK,T2_DELIVERY_PREDICTION_ZQ,MATERIALS_DESC,FLOW_FLAG_NAME
