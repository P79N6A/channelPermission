...
@Controller
@RequestMapping(value = "hporder")
public class HpOrderOntimeRateReverseReportController {
    /**
     * 列表查询每次最大条数
     */
    ...
    private static org.apache.log4j.Logger log    = org.apache.log4j.LogManager
            .getLogger(HpOrderOntimeRateReverseReportController.class);

    @GetMapping("hporderOntimeRateReverseReport")
    public String mytest(HttpServletRequest request, HttpServletResponse response,
        ...
        return "report_data/HpOrderOntimeRateReverseReport";
    }
    ...
    @RequestMapping(value = { "/getHpOrderOntimeRateReverseReportDetailList" }, method = { RequestMethod.POST })
    ...
    void exportOrderOntimeRateReverseReportDetail(HttpServletRequest request,
                                                  HttpServletResponse response,
                                                  @RequestParam(required = true) String nodeType,
                                                  @RequestParam(required = false) String cOrderSn) throws Exception {
        ...
        try {
            ...
            List<Map<String, Object>> list = this
                    .getOntimeRateReverseDetailList(repairIdCache
                                    .get(WebUtil.currentUserId(request) + "-" + nodeType).getRepairId(), cOrderSn,
                            nodeType, null);
            Map<String, Object> distanceMap = new HashMap<String, Object>();
            this.getDistanceInfo(distanceMap);
            addDistance(list, distanceMap);
...
//                            : "是");
    ...
    @RequestMapping(value = { "/exportHpOrderOntimeRateReverseReport.html" }, method = { RequestMethod.GET })
