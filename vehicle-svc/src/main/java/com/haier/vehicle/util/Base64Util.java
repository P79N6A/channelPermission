...
public class Base64Util {
	...
	public static String encode(byte abyte0[]) {
		...
		for (int k1 = 0; k1 < k; k1++) {
			...
			byte byte11 = (byte5 & -128) != 0 ? (byte) (byte5 >> 2 ^ 192)
					: (byte) (byte5 >> 2);
			byte byte14 = (byte8 & -128) != 0 ? (byte) (byte8 >> 4 ^ 240)
					: (byte) (byte8 >> 4);
			byte byte16 = (byte10 & -128) != 0 ? (byte) (byte10 >> 6 ^ 252)
					: (byte) (byte10 >> 6);
		...
		if (j == 8) {
			...
			byte byte12 = (byte6 & -128) != 0 ? (byte) (byte6 >> 2 ^ 192)
					: (byte) (byte6 >> 2);
			...
			byte byte13 = (byte7 & -128) != 0 ? (byte) (byte7 >> 2 ^ 192)
					: (byte) (byte7 >> 2);
			byte byte15 = (byte9 & -128) != 0 ? (byte) (byte9 >> 4 ^ 240)
					: (byte) (byte9 >> 4);
