...
public interface ShopOrderWorkflowsRunTimeService {
    /**
     * 获取开单及时率报表数据
     * @return 网单列表集合
     */
     ...
     * @return 网单列表集合
     */
    List<Map<String, Object>> getDisplayOutTimeList(Integer startDate, Integer endDate);
     ...
     * @return 网单列表集合
     */
    Map<String, Object> get1041StoreExistInfo(Integer orderRepairId);
