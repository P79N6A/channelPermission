...
/**
 * 苏宁分销-营销费用维护 SN_ODS_TMFX_PROMOTION_COST
 *
 * @version 1.0 2017-10-23
 */
@Excel(filename = "苏宁营销费用维护导出")
public class SNOdsTMFXPromotionCost implements Serializable {
  /**
   * 主键
   * SN_ODS_TMFX_PROMOTION_COST.ID
   */
  private int id;

  /**
   * 年度
   * SN_ODS_TMFX_PROMOTION_COST.YEAR
   */
  ...
  /**
   * 期间
   * SN_ODS_TMFX_PROMOTION_COST.MONTH
   */
  ...
  /**
   * 生态店
   * SN_ODS_TMFX_PROMOTION_COST.ECOLOGY_SHOP
   */
  ...
  /**
   * 品牌
   * SN_ODS_TMFX_PROMOTION_COST.BRAND
   */
  ...
  /**
   * 费用描述
   * SN_ODS_TMFX_PROMOTION_COST.COST_DES
   */
  ...
  /**
   * 营销费用金额
   * SN_ODS_TMFX_PROMOTION_COST.yx_cost_amount
   */
  ...
  /**
   * 创建时间
   * SN_ODS_TMFX_PROMOTION_COST.CREATE_TIME
   */
  ...
  /**
   * 创建人
   * SN_ODS_TMFX_PROMOTION_COST.CREATE_BY
   */
  ...
  /**
   * 初审状态
   * SN_ODS_TMFX_PROMOTION_COST.FIRST_AUDIT
   */
  ...
  /**
   * 复审状态
   * SN_ODS_TMFX_PROMOTION_COST.SECOND_AUDIT
   */
  ...
  /**
   * 审核人
   * SN_ODS_TMFX_PROMOTION_COST.AUDIT_BY
   */
  ...
  /**
   * 审核时间
   * SN_ODS_TMFX_PROMOTION_COST.AUDIT_TIME
   */
  ...
  /**
   * 主键<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.ID<br>
   * @return ID
   */
  public int getId() {
    return id;
  ...
  /**
   * 年度<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.YEAR<br>
   * @return YEAR
   */
  ...
  /**
   * 期间<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.MONTH<br>
   * @return MONTH
   */
  ...
  /**
   * 生态店<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.ECOLOGY_SHOP<br>
   * @return ECOLOGY_SHOP
   */
  ...
  /**
   * 品牌<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.BRAND<br>
   * @return BRAND
   */
  ...
  /**
   * 费用描述<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.COST_DES<br>
   * @return COST_DES
   */
  ...
  /**
   * 创建时间<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.CREATE_TIME<br>
   * @return CREATE_TIME
   */
  ...
  /**
   * 创建人<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.CREATE_BY<br>
   * @return CREATE_BY
   */
  ...
  /**
   * 初审状态<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.FIRST_AUDIT<br>
   * @return FIRST_AUDIT
   */
  ...
  /**
   * 复审状态<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.SECOND_AUDIT<br>
   * @return SECOND_AUDIT
   */
  ...
  /**
   * 审核人<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.AUDIT_BY<br>
   * @return AUDIT_BY
   */
  ...
  /**
   * 审核时间<br>
   * 对应数据库表字段：SN_ODS_TMFX_PROMOTION_COST.AUDIT_TIME<br>
   * @return AUDIT_TIME
   */
