...
/**
 *                       
 * @Filename: CgoGenuineRejectItem.java
 * @Version: 1.0
 * @Author: yanrp 燕如朋
 * @Email: yanrp110428@dhc.com.cn
 *
 */
public class CgoGenuineRejectItemNew implements Serializable {

    /**
     *Comment for <code>serialVersionUID</code>
     */
    private static final long serialVersionUID = 5071678899983819735L;
    private String            wp_order_id;                            //退货单号
    private String            order_id;                               //退货子单号
    ...
    private String            si_ou_slipNo;                           //OU单号
    private String            materials_id_R;                         //物料号R码
    private String            slip_date_display;                      //开单日期
