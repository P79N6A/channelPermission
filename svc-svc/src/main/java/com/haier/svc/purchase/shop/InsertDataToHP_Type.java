...
public class InsertDataToHP_Type {
    ...
    protected List<InsertDataToHP_Type.Inputs> inputs;
     ...
     * {@link InsertDataToHP_Type.Inputs }
     * 
     * 
     */
    public List<InsertDataToHP_Type.Inputs> getInputs() {
        if (inputs == null) {
            inputs = new ArrayList<InsertDataToHP_Type.Inputs>();
        }
        return this.inputs;
    }
