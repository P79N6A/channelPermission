...
public class StockBizHelper {
    ...
    public static Map<String, String> getAllProductssCodes(ItemService itemService) {
     ...
     */
    public static void linkageUpdateStockForSales(ItemService itemService,
    ...
    public static void updateStockForSale(ItemService itemService, StockInvSectionService stockInvSectionService,
     ...
     * @return
     */
    public static ItemBase getItemBaseBySku(ItemService itemService, String sku) {
     ...
     * @return
     */
    public static ItemAttribute getItemAttributeByValueSetIdAndValue(ItemService itemService,
                                                                     String valueSetId,
                                                                     String value) {
     ...
     * @param baseStock
     */
    public static void assignmentValue2InvBaseStock(ItemService itemService,
                                                    StockInvSectionService stockInvSectionService,
     ...
     * @param stock
     */
    public static void assignmentValue2InvStock(ItemService itemService,
     ...
     * @param baseStockLog
     */
    public static void assignmentValue2InvBaseStockLog(ItemService itemService,
                                                       StockInvSectionService stockInvSectionService,
