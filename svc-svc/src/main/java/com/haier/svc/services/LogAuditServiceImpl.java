...
import com.haier.svc.bean.GateOfMaterialsAccRateItem;
import com.haier.svc.service.LogAuditService;
@Service
public class LogAuditServiceImpl implements LogAuditService {
	
	private static final String            TIMEGATE          = "haier_time_gate_t"; 
	...
	@Override
	public void log(String orderId, int type, String content,
			String operUserName, String operUserId, String jude_way_channel,
			String gate_way_channel, String channel, String category) {
        ...
        purchaseLogAuditService.saveAuditLog(lai);
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public void unionLog(String model, Object oldData, Object newData,
			String type, String operUserName, String orderId) {
		// TODO Auto-generated method stub
        ...
        if (TIMEGATE.equals(model)) {
            ...
            for (int i = 0; i < timeGateOldArr.length; i++) {
