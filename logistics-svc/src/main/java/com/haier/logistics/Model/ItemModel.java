...
public class ItemModel {
    @Autowired
    private NetPointsService netPointsDao;
    @Autowired
    private ProductTypesService productTypesService;
    /*  @Autowired
    private BrandsService brandsDao;
    @Autowired
    private PaymentsService paymentsDao;
    @Autowired
    private EisExternalSkuService eisExternalSkuService;
    @Autowired
    private ProductTypesService productTypesDao;
    @Autowired
    private ShopItemBaseService itemBaseDao;
    @Autowired
    private ShopItemAttributeService itemAttributeDao;*/
    @Autowired
    private ProductsNewService productsNewDao;
    @Autowired
    private ProductCatesService productCatesDao;
   /* private PurchaseLesFiveYardsService purchaseLesFiveYardsService;
    @Autowired
    private RegionsService regionDao;*/
    ...
    public NetPoints getByNetPointN8(String netPointN8) {
        ...
        return netPointsDao.getByNetPointN8(netPointN8);
    }
    /**
     * 根据sku获取产品对象
     * @param sku 物料号
    ...
    /*public ProductsNew getProductsBySku(String sku) {
        return productsNewDao.getBySku(sku);
    }
    public Brands getBrandsById(Integer brandId) {
        return brandsDao.get(brandId);
    }
    ...
    public Payments getPaymentByCode(String paymentCode) {
        ...
        return paymentsDao.getByCode(paymentCode);
    }
     ...
     *//**
     ...
     public void updateSaleNumBySku(ProductsNew products) {
         productsNewDao.updateSaleNumBySku(products);
     }
     ...
     *//**
     ...
     public List<ProductBase> getAllOnSaleSkuList() {
         return productsNewDao.getAllSkusListBySale("1");
     }
     */
     /**
    ...
    /* public ProductBase getProductBaseBySku(String sku) {
         return productsNewDao.getBaseBySku(sku);
     }
...
*/
    ...
    /* public void saveItemAttribute(ItemAttribute attribute) {
         List<ItemAttribute> valueList = itemAttributeDao.getByValueAndValueSetId(attribute);
         if (valueList != null && valueList.size() > 0) {
             attribute.setId(valueList.get(0).getId());
         }
         if (attribute.getId() != null) {
             itemAttributeDao.update(attribute);
         } else {
...
/*
     public List<ItemBase> getIncompleteItemBaseList() {
         return itemBaseDao.getIncompleteItemBaseList();
     }
*/
...
*/
    ...
    /* public List<ItemAttribute> queryItemAttributeWithLike(ItemAttribute itemAttribute) {
         ...
         return itemAttributeDao.queryItemAttributeWithLike(itemAttribute);
     }*/
    ...
    /* public Integer countItemAttributeWithLike(ItemAttribute itemAttribute) {
         ...
         return itemAttributeDao.countItemAttributeWithLike(itemAttribute);
     }*/
    ...
    /* public List<ItemAttribute> queryProductGroupByCbsCategory(String cbsCategory) {
         return itemAttributeDao.queryProductGroupByCbsCategory(cbsCategory);
     }*/
   ...
   /*  public Integer updateItemBaseById(ItemBase base) {
         ...
         return itemBaseDao.updateNotNull(base);
     }
*/
     /**
     ...
     */
     ...
     /*public NetPoints getByNetPointByCode(String netPointCode) {
         ...
         return netPointsDao.getByNetPointByCode(netPointCode);
     }
     */
    ...
    /* public List<EisExternalSku> getBySku(String sku) {
     ...
     /*public List<ItemBase> findItemBaseByMaterialId(String material_id) {
         ...
         return itemBaseDao.findItemBaseByMaterialId(material_id);
     }*/
     /**
    ...
    /* public List<ItemAttribute> getByValueSetId(String valueSetId) {
         return itemAttributeDao.getByValueSetId(valueSetId);
     }
     public List<String> getCbsCategoryByProductGroup(Map<String, Object> map) {
         return itemAttributeDao.getCbsCategoryByProductGroup(map);
     }
   ...
   /*  public Integer manualSyncMdmBySku(ItemBase itemBase, String modifier) {
         ...
         if (tmpItemBase != null) {
             ...
             itemBase.setLastUpd(new Date());
             return itemBaseDao.updateNotNull(itemBase);
         }
         return 0;
         //        else {
         //            itemBase.setIsAutoUpdate(1);
...
*/
   ...
   /*  public String getRegionsCode(Map<String, Object> params) {
         ...
         Regions provinceRegion = regionDao.getRegions(params);
         ...
         Regions cityRegion = regionDao.getRegions(params);
         if (cityRegion == null) {
         ...
         Regions areaRegion = regionDao.getRegions(params);
         if (areaRegion == null) {
    ...
    /*  *//*
     public List<Map<String, Object>> getOnSaleBigProducts() {
         ...
         List<ProductsNew> products = productsNewDao.getOnSaleBigProducts();
...
*/
    ...
    public ProductsNew getProductsById(Integer id) {
        ProductsNew productsNew=productsNewDao.get1(id);
        return productsNew;
    }
    ...
    /* *//**
     ...
     public List<Map<String, Object>> getOnSaleProducts(Map<String, Object> paramMap) {
         ...
         List<ProductBase> productBases = productsNewDao.getAllSkusList(paramMap);//获取所有sku
         if (productBases == null || productBases.isEmpty()) {
             throw new BusinessException("没有上架的商品");
         }
         List<Brands> brands = brandsDao.getAllBrands();//获取所有品牌
         ...
         List<ProductCates> productCates = productCatesDao.getAllProductCates();//获取所有品类
     ...
     *//**
     ...
     public List<ProductBase> getAllSkuList() {
         return productsNewDao.getAllSkusListBySale(null);
     }
     *//**
