...
public class CertificateUtils {
     ...
     * 根据密钥库获得私钥
     * </p>
     * @param keyStoreBytes 密钥库
     * @param alias 密钥库别名
     * @param password 密钥库密码
     * @return
     * @throws Exception
     */
    public static PrivateKey getPrivateKey(byte[] keyStoreBytes, String alias, String password)
                                                                                               throws Exception {
        KeyStore keyStore = getKeyStore(keyStoreBytes, password);
     ...
     * @throws Exception
     */
    private static KeyStore getKeyStore(byte[] keyStoreBytes, String password) throws Exception {
     ...
     * </p>
     *
     * @param certificateBytes 证书
     * @return
     * @throws Exception
     */
    public static PublicKey getPublicKey(byte[] certificateBytes) throws Exception {
        Certificate certificate = getCertificate(certificateBytes);
     ...
     * @throws Exception
     */
    private static Certificate getCertificate(byte[] certificateBytes) throws Exception {
     ...
     * @throws Exception
     */
    private static Certificate getCertificate(byte[] keyStoreBytes, String alias, String password)
                                                                                                  throws Exception {
        KeyStore keyStore = getKeyStore(keyStoreBytes, password);
     ...
     * @throws Exception
     */
    public static byte[] encryptByPrivateKey(byte[] data, byte[] keyStoreBytes, String alias,
                                             String password) throws Exception {
        // 取得私钥
        PrivateKey privateKey = getPrivateKey(keyStoreBytes, alias, password);
     ...
     * @throws Exception
     */
    public static byte[] encryptFileByPrivateKey(String filePath, byte[] keyStoreBytes,
                                                 String alias, String password) throws Exception {
        byte[] data = fileToByte(filePath);
        return encryptByPrivateKey(data, keyStoreBytes, alias, password);
    }
    ...
    public static void encryptFileByPrivateKey(String srcFilePath, String destFilePath,
                                               byte[] keyStoreBytes, String alias, String password)
                                                                                                   throws Exception {
        // 取得私钥
        PrivateKey privateKey = getPrivateKey(keyStoreBytes, alias, password);
        Cipher cipher = Cipher.getInstance(privateKey.getAlgorithm());
     ...
     * @throws Exception
     */
    public static byte[] decryptByPrivateKey(byte[] encryptedData, byte[] keyStoreBytes,
                                             String alias, String password) throws Exception {
        // 取得私钥
        PrivateKey privateKey = getPrivateKey(keyStoreBytes, alias, password);
        Cipher cipher = Cipher.getInstance(privateKey.getAlgorithm());
     ...
     * @throws Exception
     */
    public static byte[] encryptByPublicKey(byte[] data, byte[] certificatePath) throws Exception {
        // 取得公钥
     ...
     * @throws Exception
     */
    public static byte[] decryptByPublicKey(byte[] encryptedData, byte[] certificateBytes)
                                                                                          throws Exception {
        PublicKey publicKey = getPublicKey(certificateBytes);
        Cipher cipher = Cipher.getInstance(publicKey.getAlgorithm());
     ...
     * @throws Exception
     */
    public static void decryptFileByPublicKey(String srcFilePath, String destFilePath,
     ...
     * @throws Exception
     */
    public static byte[] sign(byte[] data, byte[] keyStoreBytes, String alias, String password)
                                                                                               throws Exception {
        // 获得证书
        X509Certificate x509Certificate = (X509Certificate) getCertificate(keyStoreBytes, alias,
            password);
        // 获取私钥
        KeyStore keyStore = getKeyStore(keyStoreBytes, password);
        //        System.out.print("===========");
        //        System.out.print(keyStore.getCertificate(alias));
        //        System.out.print("===========");
        // 取得私钥
        PrivateKey privateKey = (PrivateKey) keyStore.getKey(alias, password.toCharArray());
        // 构建签名
     ...
     */
    @Deprecated
    public static byte[] signFile(String filePath, byte[] keyStoreBytes, String alias,
                                  String password) throws Exception {
     ...
     * @throws Exception
     */
    public static byte[] generateFileSign(String filePath, byte[] keyStoreBytes, String alias,
                                          String password) throws Exception {
        byte[] sign = new byte[0];
        // 获得证书
        X509Certificate x509Certificate = (X509Certificate) getCertificate(keyStoreBytes, alias,
     ...
     * 
     * @param date 日期
     * @param certificateBytes 证书存储路径
     * @return
     */
    public static boolean verifyCertificate(Date date, byte[] certificateBytes) {
        Certificate certificate;
        try {
            certificate = getCertificate(certificateBytes);
     ...
     * </p>
     * 
     * @param keyStoreBytes 密钥库存储路径
     * @param alias 密钥库别名
     * @param password 密钥库密码
     * @return
     */
    public static boolean verifyCertificate(Date date, byte[] keyStoreBytes, String alias,
                                            String password) {
        Certificate certificate;
        try {
            certificate = getCertificate(keyStoreBytes, alias, password);
            return verifyCertificate(certificate);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
     ...
     * @return
     */
    public static boolean verifyCertificate(byte[] keyStoreBytes, String alias, String password) {
        return verifyCertificate(new Date(), keyStoreBytes, alias, password);
    }
    ...
    public static boolean verifyCertificate(byte[] certificateBytes) {
        return verifyCertificate(new Date(), certificateBytes);
    }
