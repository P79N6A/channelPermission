...
public interface VomOrderService {
	...
	ServiceResult<VOMOrderResponse> synOrderInfo(VOMSynOrderRequire synOrderRequire);
	
	ServiceResult<Boolean> stopCgoGenuineRejectList(Map<String, Object> paramMap);
	
	ServiceResult<VOMOrderResponse> cancelVomOrderInfo(VOMCancelOrderRequire vOMCancelOrderRequire);
