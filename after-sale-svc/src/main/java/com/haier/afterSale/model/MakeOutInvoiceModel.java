...
import com.haier.afterSale.services.EInvoiceServiceImpl;
import com.haier.afterSale.services.InvoiceToTaxServiceImpl;
...
public class MakeOutInvoiceModel {
    ...
    @Autowired
    private EInvoiceServiceImpl        eInvoiceServiceImpl;
//    private InvoiceToSAPService    invoiceToSAPService;
    @Autowired
    private ThreadHelper           threadHelper;
    @Autowired
    private InvoiceToTaxServiceImpl    invoiceToTaxService;
...
//        }
    ...
    public void updateInvoiceStatus(Invoices edit, boolean hasPushData) {
        ...
        try {
            ...
            Integer pushType = OrderBizHelper.getInvoiceSAPLogsOfPushType(edit, orderProductsDao);
            boolean sendSap = OrderBizHelper.handelInvoiceSAPLogs(edit, pushType, orderProductsDao,
