...
//    private InvStoreService invStoreDao;
    ...
    public List<Stock> getStockIncrement(Date dateTime, String channelCode) {
        ...
        InvStockChannel invStockChannel = invStockChannelService.getByCode(channelCode);
    ...
    public Map<Integer, List<String>> getCitySkusByChannel(String channel) {
        // 确定可用库存渠道
        InvStockChannel stockChannel = invStockChannelService.getByCode(channel);
    ...
    public Stock getStockBySkuAndRegion(String sku, int regionId, String channelCode,
        ...
        InvStockChannel stockChannel = invStockChannelService.getByCode(channelCode);
        if (stockChannel == null)
