...
import com.haier.afterSale.model.PurchaseGdQueueModel;
import com.haier.afterSale.service.PurchaseGdService;
import com.haier.common.ServiceResult;
import com.haier.purchase.data.model.PurchaseGdQueue;
@Service
public class PurchaseGdServiceImpl implements PurchaseGdService {
    private static Logger        logger = LogManager.getLogger(PurchaseGdServiceImpl.class);
    @Autowired
