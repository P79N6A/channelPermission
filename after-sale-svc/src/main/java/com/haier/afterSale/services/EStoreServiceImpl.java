...
import com.haier.afterSale.model.EStoreStockModel;
import com.haier.afterSale.model.EStoreSyncModel;
import com.haier.afterSale.model.StockOrderLockModel;
import com.haier.afterSale.service.EStoreService;
...
public class EStoreServiceImpl implements EStoreService {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.LogManager
        .getLogger(EStoreServiceImpl.class);
    @Autowired
    ...
    @Autowired
    private ItemServiceImplNew                    itemServiceImplNew;
    @Autowired
    ...
    public ServiceResult<Stock> getNewRealTimeStockFromEcForPay(String sku, Integer storeId,
        ...
        try {
            SgStore sgStore = sgStoreService.getSgStoreById(storeId);
    ...
    public void setItemService(ItemServiceImplNew itemService) {
    ...
    public void setSgStoreDao(SgStoreService sgStoreDao) {
        this.sgStoreService = sgStoreDao;
    }
