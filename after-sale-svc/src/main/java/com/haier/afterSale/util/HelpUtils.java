...
public class HelpUtils {
    ...
    public String getReasonCode(String reason) {
    	if("价格问题".equals(reason)){
    		return "156";
    	}else if("大小尺寸".equals(reason)){
    		return "157";
    	}else if("颜色款式".equals(reason)){
    		return "158";
    	}else if("质量问题".equals(reason)){
    		return "159";
    	}else if("安装问题".equals(reason)){
    			return "160";
    	}else if("发票问题".equals(reason)){
				return "161";
		}else if("配送问题".equals(reason)){
			return "162";
		}else if("库存问题".equals(reason)){
			return "163";
		}else if("地址问题".equals(reason)){
			return "164";
		}else if("七天无理由".equals(reason)){
			return "165";
		}else if("其他".equals(reason)){
			return "166";
		}
