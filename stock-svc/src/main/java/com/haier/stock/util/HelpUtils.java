...
public class HelpUtils {
    ...
    @Autowired
    private StockCenterOrderServiceImpl             orderService;
    ...
    public void setOrderService(StockCenterOrderServiceImpl orderService) {
    ...
    public void setInvoiceService(StockCenterInvoiceNewServiceImpl invoiceService) {
