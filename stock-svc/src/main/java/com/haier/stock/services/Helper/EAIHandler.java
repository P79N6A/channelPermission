...
public class EAIHandler {
  ...
  //  private EisExternalSkuService      eisExternalSkuDao;
    @Autowired
     ...
     * @param flag
     * @param message
     * @param responseStockTrans
     * @param responseStockQtys
     */
    public Integer getInventoryTranFromLes(String dateBegin,
                                           String dateEnd,
                                           String timeBegin,
                                           String timeEnd,
                                           String secType,
        ...
        dataLog.setInterfaceCode(com.haier.eis.model.EisInterfaceDataLog.INTERFACE_CODE_GET_STOCK_TRANS_FROM_LES);
        ...
        try {
            ...
            //调用接口
            //URL url = new URL(this.getWsdlPath("GetKUCUNInfoFromLESToEHAIER.wsdl"));
     ...
     * @return
     *//*
    public OutputType getPurchasePriceFromCrm(String corpCode, String custCode, String sku,
                                              String regionCode) {
        // 要记录接口数据日志
        ...
        try {
            ...
            GetInvRebateInfoFromIHS_Service service = new GetInvRebateInfoFromIHS_Service(url);
    ...
    *//**
    ...
    public List<ZLESDCMS24> getBomInfoFromLes(String inputDate) {
        ...
        try {
            ...
            GetBomInfoFromLESToEHAIER_Service service = new GetBomInfoFromLESToEHAIER_Service(url);
    ...
    *//**
    ...
    public Boolean createPurchaseOrderToLes(PurchaseOrderQueueWrapper purchaseOrderQueueWrapper,
        ...
        try {
            ...
            List<com.haier.cbs.eai.createpurchaseordertoles.InputType> inputList = new ArrayList<com.haier.cbs.eai.createpurchaseordertoles.InputType>();
            com.haier.cbs.eai.createpurchaseordertoles.InputType input = new com.haier.cbs.eai.createpurchaseordertoles.InputType();
            //1.商城订单来源代码 - 30
            if (source.length() > 30) {
            ...
            //调用les接口
            CreateSCOrderToLES soap = new CreateSCOrderToLES_Service(new URL(
                this.getWsdlPath("CreateSCOrderToLES.wsdl"))).getCreateSCOrderToLESSOAP();

            List<com.haier.cbs.eai.createpurchaseordertoles.OutputType> outPutList = soap
            ...
            com.haier.cbs.eai.createpurchaseordertoles.OutputType output = outPutList.get(0);
    ...
    *//**
     ...
     * @return
     *//*
    public com.haier.cbs.eai.createpurchaseordertoles.OutputType createTransferLineToLes(InvTransferLine transferLine,
                                                                                         String transferFrom,
                                                                                         String transferTo) {
        //组装参数
        ...
        try {
            ...
            dataLog.setElapsedTime(System.currentTimeMillis() - startTime);
            dataLog.setCreateTime(new Date());
            com.haier.cbs.eai.createpurchaseordertoles.OutputType output = outPutList == null ? null
                : outPutList.get(0);
            dataLog.setResponseData(new Gson().toJson(output));
            try {
                EisInterfaceDataLogService.insert(dataLog);
    ...
    public com.haier.cbs.eai.jdeandleslosevalidity.JdeAndLesLoseValidityResponse.Out cancelTransferLineToLes(String lineNum,
                                                                                                             String lesNum) {
        // 要记录接口数据日志
        EisInterfaceDataLog dataLog = new EisInterfaceDataLog();
        ...
        Long startTime = System.currentTimeMillis();
        com.haier.cbs.eai.jdeandleslosevalidity.JdeAndLesLoseValidity_Type.In input = new com.haier.cbs.eai.jdeandleslosevalidity.JdeAndLesLoseValidity_Type.In();
        input.setABGRU("95");
        ...
        try {
            //调用les接口
            JdeAndLesLoseValidity soap = new JdeAndLesLoseValidity_Service(new URL(
                this.getWsdlPath("JdeAndLesLoseValidity.wsdl"))).getJdeAndLesLoseValiditySOAP();
            com.haier.cbs.eai.jdeandleslosevalidity.JdeAndLesLoseValidityResponse.Out output = soap
    ...
    public com.haier.cbs.eai.selectinfofrommdm.SelectInfoFromMDMOPResponse.Output getSkuInfoFromMdm(Integer pageIndex,
                                                                                                    Date beginTime,
                                                                                                    Date endTime) {
        // 要记录接口数据日志
        EisInterfaceDataLog dataLog = new EisInterfaceDataLog();
        ...
        input.setDepartment("table_hm_value_set");
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        input.setEndTime(sdf.format(endTime));
        input.setStartTime(sdf.format(beginTime));
        input.setTableName("haiermdm.hm_value_set");
        dataLog.setRequestData(new Gson().toJson(input));
        dataLog.setRequestTime(new Date());

        //访问接口
        com.haier.cbs.eai.selectinfofrommdm.SelectInfoFromMDMOPResponse.Output output = null;
        try {
            URL url = new URL(this.getWsdlPath("SelectInfoFromMDM.wsdl"));
            ...
            output = soap.selectInfoFromMDMOP(input);
        } catch (Exception e) {
            log.error("从MDM获取sku信息时，发生未知异常", e);
            dataLog.setErrorMessage("未知异常：" + e.getMessage());
        }
    ...
    *//**
    ...
    public List<ZWDTABLE2> queryProduceCRMTidanInformationFromLess(Date date) {
        ...
        try {
            ...
            GetTidanZWDFromLESToEHAIER_Service service = new GetTidanZWDFromLESToEHAIER_Service(url);
    ...
    *//**
    ...
    private <E> InType getSelectInfoFromMDMIntype(Integer pageIndex, Date beginTime, Date endTime,
                                                  Class<E> clazz) {
    ...
    *//**
     ...
     *//*
    private <E> com.haier.cbs.eai.selectinfofrommdm.SelectInfoFromMDMOPResponse.Output getMdmOutput(InType input)
                                                                                                                 throws MalformedURLException {
        URL url = new URL(this.getWsdlPath("SelectInfoFromMDM.wsdl"));
        SelectInfoFromMDM_Service service = new SelectInfoFromMDM_Service(url);
        SelectInfoFromMDM soap = service.getSelectInfoFromMDMSOAP();
    ...
    private <E> List<E> getTargetList(String xml, Class<E> clazz) throws Exception {
        ...
        try {
            ...
            if (ItemAttribute.class.equals(clazz)) {
                ...
                jc = JAXBContext.newInstance(com.haier.cbs.eai.itembase.Output.class);
            }
            if (jc==null){
            	return null;
            }
            ...
            if (ItemAttribute.class.equals(clazz)) {
                ...
                com.haier.cbs.eai.itembase.Output out = (com.haier.cbs.eai.itembase.Output) unmarshaller
                    .unmarshal(xsr);
                if (out != null && out.getRowset() != null) {
    ...
    *//**
    ...
    private com.haier.cbs.eai.selectmdminfofrommdmbyconditon.OutputsType selectMdmInfoFromMdmByConditonOutput(InputsType input)
                                                                                                                               throws MalformedURLException {

        URL url = new URL(this.getWsdlPath("SelectMDMInfoFromMDMByConditon.wsdl"));
    ...
    *//**
    ...
    public void setEisInterfaceDataLogService(EisEisInterfaceDataLogService EisInterfaceDataLogService) {
    ...
    public EisExternalSkuDao getEisExternalSkuDao() {
        return eisExternalSkuDao;
    }
    ...
    *//**
     * 
     * @param startDate 订单订购开始时间(格式：YYYY-MM-DD)
     * @param endDate   订单订购结束时间(格式：YYYY-MM-DD)
     * @param currentPage   当前页。结果集每次返回最多2000条(格式：正整数)
     * @return 
     *//*
    public EcommerceOrderResult getOmsOnorder(String startDate, String endDate, String currentPage) {
        // 要记录接口数据日志
        EisInterfaceDataLog dataLog = new EisInterfaceDataLog();
        dataLog.setForeignKey(startDate + "_" + endDate + "_" + currentPage);
        dataLog.setInterfaceCode(EisInterfaceDataLog.INTERFACE_CODE_GET_OMS_ON_ORDER);

        Long startTime = System.currentTimeMillis();
        GetEcommerceOrder input = new GetEcommerceOrder();
        ...
        //访问接口
        EcommerceOrderResult output = null;
        try {
            URL url = new URL(this.getWsdlPath("EcommerceOrder.wsdl"));
            EcommerceOrderServiceService service = new EcommerceOrderServiceService(url);
            EcommerceOrderService soap = service.getEcommerceOrderServicePort();
            output = soap.getEcommerceOrder(startDate, endDate, currentPage);
        } catch (Exception e) {
            log.error("从OMS获取在途订单信息时，发生未知异常", e);
            dataLog.setErrorMessage("未知异常：" + e.getMessage());
        }
    ...
    *//**
    ...
    public String convertToExternalSku(String sku, String type) {
        EisExternalSku by6 = eisExternalSkuDao.getBySkuType(sku, EisExternalSku.TYPE_R);
        if (by6 == null)
            return sku;
    ...
    *//**
     ...
     * @param org 销售组织
     * @param productList 产品组
     * @param sendCode 送达方编码
     * @param haierSendCode 海尔送达方编码
     * @param lastSendDate 要求最晚到货日期
     * @return
     *//*
    public boolean createOrderToOms(OrderProducts orderProduct, String org, String productList,
                                    String unit, String sendCode, String haierSendCode,
                                    String lastSendDate, String xmlStr, String urlStr) {
        String changeLog = "推送订单至OMS";
        String remark = "";

        // 要记录接口数据日志
        EisInterfaceDataLog dataLog = new EisInterfaceDataLog();
        dataLog.setForeignKey(orderProduct.getCOrderSn());
        dataLog.setInterfaceCode(EisInterfaceDataLog.INTERFACE_CODE_CREATE_ORDER_TO_OMS);

        ServiceResult<Orders> orderResult = getOrderService().getOrder(orderProduct.getOrderId());
        Orders order = null;
        //用户姓名
        String consignee = "";
        //联系电话
        ...
        if (orderResult.getSuccess() && null != orderResult.getResult()) {
            order = orderResult.getResult();
            consignee = order.getConsignee();
            if (isLength(consignee) > 45) {
                consignee = consignee.substring(0, 15);
            }
            mobile = order.getMobile();
            if (isLength(mobile) > 20) {
                mobile = mobile.substring(0, 20);
            }
            addressRegionName = order.getRegionName() + " " + order.getAddress();
            if (isLength(addressRegionName) > 120) {
                addressRegionName = addressRegionName.substring(0, 40);
            }
        }
        ...
        //format xml内容
        //客户采购单号(网单号)
        String bstkd = orderProduct.getCOrderSn();
        //创建时间
        String creationDateStr = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
        String creationDate = creationDateStr + "T00:00:00";
        //日日顺送达方
        String kunnrSong = sendCode;
        //客户订单数
        String kwmeng = orderProduct.getNumber().toString();
        //        //库存地点
        //        String lgort = orderProduct.getSCode().substring(0, 2) + "R2";
        //客户订单数
        String matnr = orderProduct.getSku();
        //海尔送达方
        String regieSoog = haierSendCode;
        //要求最晚到货日期
        String revDate = lastSendDate;
        String revDateStr = lastSendDate.substring(0, 10);
        //产品组
        String spart = productList;
        //日日顺库存地点代码
        String storage = orderProduct.getSCode().substring(0, 2) + "R2";
        //销售组织
        String vkorg = org;
        xmlStr = MessageFormat.format(xmlStr, bstkd, creationDate, creationDateStr, kunnrSong,
            kwmeng, storage, matnr, regieSoog, revDate, revDateStr, spart, vkorg, unit, consignee,
            mobile, addressRegionName);
        dataLog.setRequestData(xmlStr);
        dataLog.setRequestTime(new Date());

        try {
            //调用OMS接口
            Map<String, String> resultMap = this.callAndGetResult(xmlStr, urlStr);
            ...
            if (!resultMap.isEmpty()) {
                if (!"S".equalsIgnoreCase(resultMap.get("messageCode"))) {
                    dataLog.setResponseStatus(EisInterfaceDataLog.RESPONSE_STATUS_ERROR);
                    dataLog.setErrorMessage(resultMap.get("messageDetail"));
                    remark = dataLog.getErrorMessage();
                    return false;
                } else {
                    dataLog.setResponseStatus(EisInterfaceDataLog.RESPONSE_STATUS_SUCCESS);
                    remark = "推送OMS成功,单号:" + resultMap.get("FIELD2");
                    //更新网单日日单状态和OMS单号
                    orderProduct.setPdOrderStatus(OrderProducts.RRSSTATUS_PRODUCTION);
                    orderProduct.setOmsOrderSn(resultMap.get("FIELD2"));
                    this.getOrderService().updateRRSById(orderProduct);
                    return true;
                }
            } else {
                dataLog.setResponseStatus(EisInterfaceDataLog.RESPONSE_STATUS_ERROR);
            ...
            try {
                EisInterfaceDataLogService.insert(dataLog);
                this.insertOperateLog(null, orderProduct, null, changeLog, remark);
            } catch (Exception ex) {
                log.error("记录接口日志时，发生未知异常：" + ex.getMessage(), ex);
            }
        }
    ...
    *//**
     ...
     * @return
     *//*
    public Holder<List<ZSDINTSDSSTOCKPUT>> getJiDiKuCunFromGvs(String sku, String factory,
                                                               String secCode) {

        Holder<List<ZSDINTSDSSTOCKPUT>> tOUTPUT = new Holder<List<ZSDINTSDSSTOCKPUT>>();
        Holder<String> message = new Holder<String>();
        Holder<String> flag = new Holder<String>();
        Holder<String> faultDetail = new Holder<String>();
        //开启日志记录
        EisInterfaceDataLog dataLog = new EisInterfaceDataLog();
        dataLog.setInterfaceCode(EisInterfaceDataLog.INTERFACE_CODE_GET_STOCK_JIDI_FROM_GVS);
        //启动日志记录时间
        Long startTime = System.currentTimeMillis();
        dataLog.setRequestTime(new Date());
        try {
            ...
            parameters.put("MATNR", sku);
            parameters.put("WERKS", factory);
            parameters.put("LGORT", secCode);
            dataLog.setRequestData(JsonUtil.toJson(parameters));
            dataLog.setForeignKey(sku + "&" + secCode);

            //设置请求参数
            List<ZSDINTSDSSTOCKPUT> tINPUT = new ArrayList<ZSDINTSDSSTOCKPUT>();
            ZSDINTSDSSTOCKPUT stockPut = new ZSDINTSDSSTOCKPUT();
            stockPut.setMATNR(sku);
            stockPut.setWERKS(factory);
            stockPut.setLGORT(secCode);
            tINPUT.add(stockPut);
            //请求库存
            URL url = new URL(this.getWsdlPath("QueryBaseGroundStockFromGVS.wsdl"));
            QueryBaseGroundStockFromGVS_Service service = new QueryBaseGroundStockFromGVS_Service(
                url);
            QueryBaseGroundStockFromGVS soap = service.getQueryBaseGroundStockFromGVSSOAP();

            soap.queryBaseGroundStockFromGVS("EHAIER", tINPUT, tOUTPUT, message, flag, faultDetail);
            dataLog.setResponseData(JsonUtil.toJson(tOUTPUT));
            dataLog.setElapsedTime(System.currentTimeMillis() - startTime);
            dataLog.setResponseTime(new Date());
            dataLog.setResponseStatus(EisInterfaceDataLog.RESPONSE_STATUS_SUCCESS);
        } catch (Exception e) {
            log.error("getJiDiKuCunFromGvs:请求基地库存失败,sku=" + sku + ", secCode=" + secCode
                      + ", factory=" + factory);
            dataLog.setResponseTime(new Date());
            dataLog.setResponseData(JsonUtil.toJson(tOUTPUT));
            dataLog.setElapsedTime(System.currentTimeMillis() - startTime);
            dataLog.setCreateTime(new Date());
            dataLog.setResponseStatus(EisInterfaceDataLog.RESPONSE_STATUS_ERROR);
            dataLog.setErrorMessage("getJiDiKuCunFromGvs:请求基地库存失败,sku=" + sku + ", secCode="
                                    + secCode + ", factory=" + factory + e.getMessage());
            e.printStackTrace();
        }
        EisInterfaceDataLogService.insert(dataLog);
        return tOUTPUT;
    ...
    private Map<String, String> callAndGetResult(String xmlStr, String urlStr) throws Exception {
        URL url = new URL(urlStr
                          + "/EAI/RoutingProxyService/EAI_SOAP_ServiceRoot?INT_CODE=CRM_INT_OMS_3");
        //        URL url = new URL(urlStr + "/EAI/RoutingProxyService/OMS");
        ...
        out.write(data);
        out.close();
        byte[] datas = this.readInputStream(httpConn.getInputStream());
        String result = new String(datas);
        Document doc = DocumentHelper.parseText(result);
        Element el = (Element) doc.getRootElement().elements().get(1);//Body
        el = (Element) el.elements().get(0);//createRrsOrderResponse
        el = (Element) el.elements().get(0);//result15
        el = (Element) el.elements().get(0);//Result15
        @SuppressWarnings("unchecked")
    ...
    private void insertOperateLog(Orders order, OrderProducts orderProduct, String operator,
        ...
        log.setPaymentStatus(null == order ? 0 : order.getPaymentStatus());
    ...
    *//**
     ...
     * @return 
     *//*
    private int isLength(Object o) {
        try {
            if (null == o) {
                return 0;
            } else {
                return o.toString().trim().getBytes("utf-8").length;
            }
        } catch (UnsupportedEncodingException e) {
            log.error("[EAIHandler_isLength]汉字转化时发生未知异常:", e);
            return 0;
        }
    }*/
}
