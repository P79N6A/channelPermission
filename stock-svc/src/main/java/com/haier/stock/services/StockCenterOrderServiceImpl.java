...
import com.haier.stock.service.StockCenterOrderService;

@Service
public class StockCenterOrderServiceImpl implements StockCenterOrderService {
    private static Logger log = LoggerFactory.getLogger(StockCenterOrderServiceImpl.class);
    @Autowired
