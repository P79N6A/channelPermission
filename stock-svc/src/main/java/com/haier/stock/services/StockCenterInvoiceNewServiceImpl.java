...
import com.haier.stock.service.StockCenterInvoiceNewService;
import com.haier.stock.util.DateFormatUtil;
@Service
public class StockCenterInvoiceNewServiceImpl implements StockCenterInvoiceNewService {
    private static Logger         log    = LoggerFactory.getLogger(StockCenterInvoiceNewServiceImpl.class);
    @Autowired
