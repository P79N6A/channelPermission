...
@Service
public class StockCenterItemServiceImplNew implements StockCenterItemServiceNew {
    private static Logger log = LoggerFactory.getLogger(StockCenterItemServiceImplNew.class);
    @Autowired
     ...
     * @return 更新结果
     * @see com.haier.StockCenterItemService.item.service.ItemService#saveItemAttribute(com.haier.cbs.item.entity.ItemAttribute)
     */
    @Override
     ...
     * @param base 产品治疗
     * @return 执行结果
     * @see com.haier.StockCenterItemService.item.service.ItemService#saveItemBase(com.haier.cbs.item.entity.ItemBase)
     */
    @Override
     ...
     * @see com.haier.StockCenterItemService.item.service.ItemService#getIncompleteItemBaseList()
     */
    @Override
